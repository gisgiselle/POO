...
public class Mapa3 extends MapaBase implements Serializable{
    ...
    public Mapa3(Heroe h, Main main, int i, int j, Personaje malo, Boss boss, int mochila,int sHp,int sSp,boolean encontroArma,boolean encontroDefensa,boolean entroPelea,boolean agarroVida,boolean agarroEnergia){
    ...
    public void Arma(int mochila){
        this.mochila=mochila;
        Objeto objj= new Arma("Lapiz",14,7);
    ...
    public void ObjetoDefensa(int mochila){
        this.mochila=mochila;
        Objeto ccosososcoos= new ObjetoDefensa("zapato",30,52);
